...
public:
     ...
     */
    int
    daysOfMonth(int month = -1, int year = -1) const;
     ...
     */
    int
    daysBeforeMonth(int month = -1, int year = -1) const;
     ...
     */
    int
    daysAfterMonth(int month = -1, int year = -1) const;
    ...
    string
    s(bool onlyDate = false) const;

    friend inline ostream&
    operator<<(ostream &os, Time &other) {
        os << other.s();
        return os;
    }
}; // Time
